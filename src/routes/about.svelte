...
<div class="main_container">
	<section>
		<div class="px-20">
			<h2 class="text-6xl font-bold mb-6">I'm Dave Edwards 🖖</h2>
			<div class="">
				<p>
				...
				<p>
					Creating magic daily on the internet. You can send me an email at <span class="info-text"
						>adeneyeabiodun@gmail.com</span
					>
				</p>
			</div>
		</div>
