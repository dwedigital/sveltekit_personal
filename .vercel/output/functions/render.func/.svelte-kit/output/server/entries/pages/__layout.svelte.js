import { c as create_ssr_component } from "../../_app/immutable/chunks/index-511472e1.js";
const app = "";
const flowbite = "";
...
<main class="${"flex justify-center mt-24"}"><div class="${"container flex justify-center w-full my-10"}">${slots.default ? slots.default({}) : ``}</div></main>
