...
${
	components[1]
		? `${(0, import_index_511472e1.v)(
				components[0] || import_index_511472e1.m,
				'svelte:component'
		  ).$$render(
				$$result,
				...
				{},
				{
					default: () => {
						return `${
							components[2]
								? `${(0, import_index_511472e1.v)(
										components[1] || import_index_511472e1.m,
										'svelte:component'
								  ).$$render(
										$$result,
										...
										{
											default: () => {
												return `${(0, import_index_511472e1.v)(
													components[2] || import_index_511472e1.m,
													'svelte:component'
...
async function render_response({
	...
	if (resolve_opts.ssr) {
		...
		is_private =
			is_private ||
			((_b = cache == null ? void 0 : cache.private) != null
				? _b
	...
	async respond(request, options = {}) {
		...
		if (!this.options.hooks) {
			const module2 = await Promise.resolve().then(() =>
				__toESM(require('./_app/immutable/chunks/hooks-bced8853.js'))
			);
			this.options.hooks = {
